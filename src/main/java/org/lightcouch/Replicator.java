...
/*	public Response save() {
		...
		JsonObject json = getReplicatorDoc();
		replicatorDocId = (replicatorDocId == null) ? generateUUID() : replicatorDocId;
		json.addProperty("_id", replicatorDocId);
		return dbc.put(dbc.resolveToBaseUri(replicatorDB), json, true);
	}*/
