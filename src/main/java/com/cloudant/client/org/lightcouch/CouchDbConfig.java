...
class CouchDbConfig {
    ...
    public CouchDbConfig(String configFile) {
        ...
        try {
            InputStream instream = CouchDbConfig.class.getClassLoader().getResourceAsStream
                    (configFile);
    ...
    private void readProperties() {
        try {
            ...
            //	dbProperties.setCreateDbIfNotExist(new Boolean(getProperty("couchdb.createdb
            // .if-not-exist", true)));
            ...
            dbProperties.setConnectionTimeout(getPropertyAsInt("couchdb.http.connection.timeout",
                    false));
